  ...
  return (
    <section className="page-shell">
      <div className="brand-card rounded-[2rem] border border-white/70 p-8 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-bold text-slate-900">Operate your institute through one polished TecOnline workspace</h1>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-600">
          Manage student intake, faculty coordination, courses, and batches the way growing language institutes actually work, without splitting operations between multiple tools.
        </p>
      </div>
