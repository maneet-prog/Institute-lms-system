...
export default function InstituteAdminAllUsersPage() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <h1 className="mb-1 text-2xl font-semibold">Institute Admin: All Users</h1>
        <p className="text-sm text-slate-600">See every user in your institute from one table.</p>
      </Card>
      <Card>
