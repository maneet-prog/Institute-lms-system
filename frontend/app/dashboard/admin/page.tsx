...
const adminHighlights = [
  ...
  { title: "Program governance", description: "Standardize course structures, subcourses, and learning hierarchies.", href: "/dashboard/admin/courses" },
  { title: "Batch operations", description: "Monitor cohort creation, schedules, and delivery readiness across branches.", href: "/dashboard/admin/batches" },
  { title: "Admissions queue", description: "Handle registrations, role assignments, and pending approvals from one place.", href: "/dashboard/admin/notifications" }
];
  ...
  return (
    <section className="page-shell">
      <div className="rounded-[2rem] bg-[#A93A30] p-8 text-white shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#f0b44c]">Super Admin Overview</p>
        <h1 className="mt-3 text-3xl font-bold">Run the TecOnline academic network from one control center</h1>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300">
          Use the central dashboard to coordinate institutes, control delivery structures, and keep registrations, teaching resources, and operations aligned across the platform.
        </p>
      </div>
